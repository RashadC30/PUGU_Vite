...
const CartLineItem = ({item, dispatch, REDUCER_ACTIONS}: PropsType) => {
    ...
    const content = (
        <li className="cart_item">
            ...
            <select name="itemQty" id="itemQty" className="cart_select" value={item.qty} aria-label="Item Quantity" onChange={onChangeQty}>{options}</select>
            ...
            <button className="cart_button" aria-label="Remove Item from Cart" title="Remove Item from Cart" onClick={onRemoveFromCart}>
                ❌
            </button>
        </li>
    )
